...
def _database_url() -> str:
    ...
    configured_path = os.getenv("HISTORY_DB_PATH")
    path = Path(configured_path) if configured_path else Path("data") / "chat_history.sqlite3"
    return sqlite_database_url(str(path))
